...

{
  ...
  # tried and rolled back: scx_lavd gives equal-or-better interactive
  # responsiveness under full CPU load with no kernel rebuilds. Requires a
  # kernel with CONFIG_SCHED_EXT (=y in the mainline config used by
