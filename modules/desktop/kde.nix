...
in
{
  ...
  environment.systemPackages = [
    ...
    # pkgs.kwin-myopic-defocus # disabled: myopic chromatic defocus effect
  ];
  ...
  nixpkgs.overlays = [
    ...
    # Disabled. Uncomment this overlay and the package entry above to
    # enable the effect again.
    # (final: prev: {
