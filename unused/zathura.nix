...
}:
{
  programs.zathura = {
    ...
    extraConfig = ''
      ...
      set synctex true
      set synctex-editor-command "emacs --no-wait --eval \"(find-file \\\"%f\\\") (goto-line %l)\""
      set font "Adwaita Mono 11"
      set zoom-step 3
      ...
      map [fullscreen] <A-F> toggle_fullscreen
      ...
      map [presentation] <A-P> toggle_presentation
